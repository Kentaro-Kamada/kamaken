...
[`kamaken::poLCA_result`](https://kentaro-kamada.github.io/kamaken/reference/poLCA_result.md)を使用する
...
[`kamaken::poLCA_BLRT`](https://kentaro-kamada.github.io/kamaken/reference/poLCA_BLRT.md)を使用する
...
```
    ...
    #> 3        4 <poLCA>          87  -289.  641.  726.      6.42

### クラスの特徴の把握

[`kamaken::poLCA_check_class`](https://kentaro-kamada.github.io/kamaken/reference/poLCA_check_class.md)を使用する
...
![](easyLCA_files/figure-html/unnamed-chunk-6-1.png)

## 参考文献

- [poLCAの使い方](https://www.jstatsoft.org/article/view/v042i10)
- [三輪哲，2009，「潜在クラスモデル入門」『理論と方法』24(2):
  345–56．](https://doi.org/10.11218/ojjams.24.345)
- [藤原翔・伊藤理史・谷岡謙，2012，「潜在クラス分析を用いた計量社会学的アプローチ――地位の非一貫性，格差意識，権威主義的伝統主義を例に」『年報人間科学』33:
  43–68．](https://doi.org/10.18910/12447)
